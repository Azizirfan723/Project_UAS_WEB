...
$result = mysqli_query($koneksi, "SELECT * FROM produk_selesai WHERE id=$id");
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Update Produk Selesai</h5>
                    <p class="text-center small">Masukkan Data</p>
                  </div>

                  <!-- Vertical Form -->
                  <form class="row g-3" method="POST" action="update-produk-selesai.php">
                    <input type="hidden" name='id' value="<?= $data['id']; ?>" />
                    <div class="col-12">
                      <label for="inputNanme4" class="form-label">Kode Barang</label>
                      <input type="text" class="form-control" id="examplekode" name="kode_barang" placeholder="Kode Barang" value="<?= $data['kode_barang']; ?>">
                    </div>
                    <div class="col-12">
                      <label for="inputEmail4" class="form-label">Nama Barang</label>
                      <input type="text" class="form-control" id="example" name="nama_barang" placeholder="Nama Barang" value="<?= $data['nama_barang']; ?>" />
                    </div>
                    <div class="col-12">
                      <label for="inputPassword4" class="form-label">Tanggal Selesai</label>
                      <input type="date" class="form-control" id="inputTanggal" name="tanggal_selesai" placeholder="Tanggal Selesai" value="<?= $data['tanggal_selesai']; ?>" />
                    </div>
                    <div class="col-12">
                    ...
                    <div class="text-center">
                      ...
                      <a href="../index.php?tampilan=produk-selesai" class="btn btn-warning">kembali</a>
                    </div>
                  </form><!-- Vertical Form -->
