...
if (isset($_POST['save'])) {
  ...
  $query = "INSERT INTO produk_dikirim VALUES ('$kode','$nama', '$tanggal', 2)";
  $result = mysqli_query($koneksi,$query);
  
  header("Location: produk-dikirim.php");
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Tambah Produk Dikirim</h5>
                    <p class="text-center small">Masukkan Data</p>
                  </div>

                  <!-- Vertical Form -->
              <form class="row g-3" action="tambah-produk-dikirim.php" method="POST">
                <div class="col-12">
